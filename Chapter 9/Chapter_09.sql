...
FROM 'C:\Users\Jo\practical-sql-main\practical-sql-main\Chapter_09\MPI_Directory_by_Establishment_Name.csv'
...
COPY state_regions
FROM 'C:\Users\Jo\practical-sql-main\practical-sql-main\Chapter_09\state_regions.csv'
WITH (FORMAT CSV, HEADER, DELIMITER ',');
